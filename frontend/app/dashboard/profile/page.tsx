...
import { User, Mail, DollarSign, Calendar, Briefcase, MapPin } from 'lucide-react';
...
export default function CustomerProfile() {
  ...
  const updateProfileMutation = useMutation({
    mutationFn: (data: any) => apiRequest('/customers/profile', {
      method: 'PUT',
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <GlassCard className="p-6 lg:col-span-1">
          <div className="text-center">
            ...
            <h2 className="text-xl font-bold text-[#141414]">{userProfile?.name}</h2>
            ...
            <div className="mt-4 p-3 bg-[#EEC643] rounded-lg">
              ...
              <p className="text-2xl font-bold text-[#141414]">{userProfile?.current_credit_score || 'N/A'}</p>
            </div>
          </div>
        </GlassCard>
        ...
        <GlassCard className="p-6 lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-lg font-semibold text-[#141414]">Personal Information</h3>
            <Button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setFormData({ ...formData, current_employment: e.target.value })}
                  disabled={!isEditing}
                  className="w-full px-3 py-2 bg-[#EFF0F2] border border-[#011638]/20 rounded-lg text-[#141414] disabled:opacity-50"
                />
              </div>
